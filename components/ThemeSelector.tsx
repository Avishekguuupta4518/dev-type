...
export default function ThemeSelector() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 md:left-auto md:right-0 mt-2 bg-bg-sub border border-border rounded-lg py-2 min-w-[160px] max-h-[300px] overflow-y-auto z-50"
