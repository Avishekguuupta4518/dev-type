...
const THEMES = [
  ...
  { id: 'github', name: 'GitHub', bg: '#0d1117' },
  { id: 'tokyo', name: 'Tokyo Night', bg: '#1a1b26' },
  { id: 'matrix', name: 'Matrix', bg: '#000000' },
  { id: 'cyberpunk', name: 'Cyberpunk', bg: '#0f0f1a' },
  { id: 'material', name: 'Material', bg: '#263238' },
  { id: 'neon', name: 'Neon', bg: '#0a0a0a' },
];
